...
import { extendVariants, Switch, SwitchProps } from '@nextui-org/react';
  ...
  ({ label, description, classNames, ...props }, ref) => (
    <CustomSwitch
      ...
      classNames={{
        ...classNames,
        base: cn(
          'inline-flex bg-default/50 backdrop-blur-lg flex-row-reverse w-full max-w-full items-center',
